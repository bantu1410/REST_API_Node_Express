...
const headCells = [
  ...
  { id: 'system', numeric: false, disablePadding: false, label: 'System Name' },
  { id: 'os', numeric: false, disablePadding: false, label: 'Operating System' },
  { id: 'date',numeric: false, disablePadding: false, label: 'Last updated on' },
];
